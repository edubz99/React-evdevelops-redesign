            ...
            <div className="section-wrapper">
                <div className="contact-wrapper" id="contact">
                    <div className="contact">
                        ...
                        <p className="contact__para">Wanna get in touch or talk about any projects? Please feel free to complete the form below or contact me via email at <a className="contact__para--link" href="mailto:evanzd91@gmail.com">evanzd91@gmail.com</a>
                        </p>
