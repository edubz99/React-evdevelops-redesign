    ...
    return (
        <div>
            ...
            <div className="about">
                    ...
                    <p className="about__brief"> I'm Front-end Developer with a history of working in the logistics and supply chain industry. I'm current freelancing as Front-end developer,developing in JavaScript ES6+, HTML, CSS, SASS, Webpack and some React.</p>
            </div>
        </div>
    )
}
